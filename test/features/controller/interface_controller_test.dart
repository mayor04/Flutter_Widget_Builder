...
void main() {
  ...
  group('Remove widget test', () {
    ...
    setUp(() {
      // TODO: for complex testing we would need to create this pattern
      // createTree({
    ...
    test('Remove and relink widget to grand parent success', () {
    ...
    test('Removing child of column, row, stack does not remove other children', () {
      interfaceController.removeWidget(container2.id);

      expect(getDetails(interfaceController, column1.id)?.children.length, 1);
    });
  });
